...
def detect(
    original_image, min_score, max_overlap, top_k, suppress=None, gen_trace=False
):
    """
...
if __name__ == "__main__":
    ...
    checkpoint_dict = {
        "HIT_SSD300": "./trained_weights/mukai_desktop_hit_230_checkpoint_ssd300_state_dict.pt",
