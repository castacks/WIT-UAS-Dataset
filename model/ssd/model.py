        ...
        for i in range(batch_size):
            ...
            for c in range(1, self.n_classes):
                ...
                if n_above_min_score == 0:
                    continue
                qualified_class_scores = class_scores[
                    score_above_min_score
                ...
                sorted_scores, sort_ind = qualified_class_scores.sort(
                    dim=0, descending=True
                )  # (n_qualified), (n_min_score)
                sorted_class_decoded_locs = class_decoded_locs[
                    sort_ind
                ]  # (n_min_score, 4)

                # Find the overlap between predicted boxes
                overlap = find_jaccard_overlap(
                    sorted_class_decoded_locs, sorted_class_decoded_locs
                )  # (n_qualified, n_min_score)
